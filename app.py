...
if not st.session_state.setup_complete:
    ...
    if "position" not in st.session_state:
        st.session_state["position"] = "Software Developer"
    ...
    with col2:
        st.session_state["position"] = st.selectbox(
            "Choose a position",
            ("Software Developer", "Data Engineer", "Quality Assurance Engineer", "Product Owner", "Product Manager"),
            index=("Software Developer", "Data Engineer", "Quality Assurance Engineer", "Product Owner", "Product Manager").index(st.session_state["position"])
        )

    st.session_state["company"] = st.selectbox(
        "Select a Company",
        ("Google", "Toyota", "United Health", "Wells Fargo", "Nestle", "Goldman Sachs", "Mckinsey & Company"),
        index=("Google", "Toyota", "United Health", "Wells Fargo", "Nestle", "Goldman Sachs", "Mckinsey & Company").index(st.session_state["company"])
    )
...
if st.session_state.setup_complete and not st.session_state.feedback_shown and not st.session_state.chat_complete:
    ...
    # Initializing the system prompt for the NeuroHIRE
